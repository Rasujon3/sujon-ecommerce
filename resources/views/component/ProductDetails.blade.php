        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                <div class="product-image">
                    <div class="product_img_box">
                        <img id="product_img1" class="w-100" src='' alt="" />
                    </div>
                    <div class="row p-2">
                        ...
                        <a href="#" class="col-3 product_img_box p-1">
                            <img id="img3" src="" alt="product_small_img3" />
                        </a>
                        <a href="#" class="col-3 product_img_box p-1">
                            <img id="img4" src="" alt="product_small_img3" />
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="pr_detail">
                    ...
                    <label class="form-label" for="p_size">Size</label>
                    <select id="p_size" class="form-select">
                    </select>

                    <label class="form-label" for="p_color">Color</label>
...
<script>
    ...
    async function productDetails() {
        ...
        document.getElementById('img1').alt = Details[0]['product']['title'];
        document.getElementById('img2').src = Details[0]['img2'];
        document.getElementById('img2').alt = Details[0]['product']['title'];
        document.getElementById('img3').src = Details[0]['img3'];
        document.getElementById('img3').alt = Details[0]['product']['title'];
        document.getElementById('img4').src = Details[0]['img4'];
        document.getElementById('img4').alt = Details[0]['product']['title'];
